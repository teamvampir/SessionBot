...
➧ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴘʏʀᴏɢʀᴀᴍ ᴠᴇʀꜱɪᴏɴ 1 =  ᴘʏʀᴏɢʀᴀᴍ
➧ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴘʏʀᴏɢʀᴀᴍ ᴠᴇʀꜱɪᴏɴ 2 =  ᴘʏʀᴏɢʀᴀᴍ ᴠ2
➧ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴘʏʀᴏɢʀᴀᴍ ꜱᴇꜱꜱɪᴏɴ 
ᴠɪᴀ ʙᴏᴛ ᴛᴏᴋᴇɴ                  =  ᴘʏʀᴏɢʀᴀᴍ ʙᴏᴛ 
➧ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴛᴇʟᴇᴛʜᴏɴ ꜱᴇꜱꜱɪᴏɴ    =  ᴛᴇʟᴇᴛʜᴏɴ 
➧ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴛᴇʟᴇᴛʜᴏɴ ꜱᴇꜱꜱɪᴏɴ 
ᴠɪᴀ ʙᴏᴛ ᴛᴏᴋᴇɴ                  =  ᴛᴇʟᴇᴛʜᴏɴ  ʙᴏᴛ
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @strsessionbot\n🍒 **ɴᴏᴛᴇ :** ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ 🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @TMK_MUSICCHANNEL 🥺"
    try:
        if not is_bot:
